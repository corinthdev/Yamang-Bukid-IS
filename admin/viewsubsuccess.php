  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">List of Products of Sub Branch:</li>
      </ol>
      <a href="sub_branches.php" class="btn btn-success"><i class="fa fa-arrow-left">&nbsp&nbsp<strong>BACK</strong></i></a><br><br>
      <h2 class="alert alert-success" align="center">ADDING OF THE PRODUCTS TO SUB BRANCH IS SUCCESSFUL</h2>
