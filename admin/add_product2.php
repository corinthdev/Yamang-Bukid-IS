<?php
  ...
  if (isset($_POST['insert'])) {
    ...
    if (count($errors) == 0) {
      $sql = "INSERT INTO sub_products (items, itemCode, beginningStocks, addStocks,endingStocks, additionalStocks,additionalStocks2,additionalStocks3,additionalStocks4,additionalStocks5,additionalStocks6,additionalStocks7,pullOut, itemSold, totalBap, picProducts, branchName) 
      ...
      header('refresh:1;location: viewsubsuccess.php'); //redirect to page
    }
    else
    {
