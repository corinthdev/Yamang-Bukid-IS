...
$sql = "SELECT * FROM sub_branches WHERE id='$subid'";
$result = $conn->query($sql);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">List of Products of Sub Branch: <?php echo $showsub;?></li>
      </ol>
      <!-- Example DataTables Card-->

      <h2 class="alert alert-success text-primary" align="center">Inventory of Sub Branch: 
        <strong class="text-success"><?php echo $showsub;?></strong>
      </h2>
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i>&nbsp <strong>Data Table of Products of Sub Branch: <?php echo $showsub;?></strong></div>
        <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                  <?php require('connection2.php');
                    ...
                    $query = "SELECT * FROM sub_products WHERE branchName = '$showsub'";
    ...
    <div class="modal fade" id="add_data_Modal" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="viewsubsuccess.php" enctype="multipart/form-data">
                ...
                <hr class="bg-info">     
                <label><strong>Total of (B.A.P)</strong></label>
                <input type="text" name="tot_bap" id="tot_bap" class="form-control " placeholder="Total of (Beg. Stocks, Add. Stocks, Pull Out)" readonly /><br>
                ...
                <input type="number" name="item_sold" id="addstocks_total"  class="form-control amount" readonly /><br>
                <label><strong>Ending Stocks</strong></label>
                <input type="number" name="ending_stocks" id="end_stocks"  class="form-control amount"  readonly /><br>         
    ...
    <script type="text/javascript" src="update_list2.js"></script>
    <script type="text/javascript" src="delete_button2.js"></script>
    <script type="text/javascript" src="ajax/view_button2.js"></script>
