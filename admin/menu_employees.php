        ...
        <div class="col-xl-3 col-sm-6 mb-3" style="height: 160px;">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">LIST OF EMPLOYEES</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="list_employees.php">
        ...
        <div class="col-xl-3 col-sm-6 mb-3" style="height: 160px;">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">ADD EMPLOYEES</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="add_employees.php">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3" style="height: 160px;">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">EXPORT LIST OF EMPLOYEES</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="export_list_of_employees.php">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
